...
/* pre:  glut window has been initialized
   post: model has been initialized */ {
	...
	planeShader.CompileShaders("shaderP.vs", "shaderP.fs");  cout << "shader ok\n"; 
...
static void onDisplay() {
	...
	// set the textures in fragment shader
	// cout << glGetUniformLocation(id, "volumeTexture"); 
	glUniform1i(glGetUniformLocation(id, "volumeTexture"), 0);
	glUniform1i(glGetUniformLocation(id, "colTexture"), 1);
	// cout << glGetUniformLocation(id, "colTexture"); 
